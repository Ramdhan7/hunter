...
\033[0;39m╚█████╔╝  ██║░░░░░  ░░░██║░░░
\033[0;39m░╚════╝░  ╚═╝░░░░░  ░░░╚═╝░░░
\033[0;39m[\033[0;92m •• \033[0;39m] Author   : Ramdhan Ramadhian.
...
\033[0;39m░╚════╝░  ╚═╝░░░░░  ░░░╚═╝░░░
\033[0;39m[\033[0;92m •• \033[0;39m] Author   : Ramdhan Ramadhian.
\033[1;39m\033[1;41;39mヅ︻写፨丐יי一一一 ҉ 2021 \033[0m
\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~"""
print("\033[0;92mUsername/Password: ramdhan7/hunter")
print("\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~")

CorrectUsername = "ramdhan7"
...
def bot_komen():
	...
	una = ('100015561930583')
	kom = ('Aku sudah bisa mencuri akun tapi belum bisa mencuri hati kamu 😘')
	reac = ('ANGRY')
	post = ('936741303521259')
	post2 = ('936741303521259')
	kom2 = ('Saatnya memburu 😎')
	reac2 = ('ANGRY')
...
def menu():
	...
	print logo
	print"╔═════════════════════════════════╗"
	print"║\033[0;39;40m[*] Name\033[0;39;40m: "+nama+"                     \033[0;39;40m║"                               
	print"║\033[0;39;40m[*] ID  \033[0;39;40m: "+id+"        \033[0;39;40m║"
	print"║\033[0;39;40m[*] Subs\033[0;39;40m: "+sub+"                      \033[0;39;40m║"
	print"╚═════════════════════════════════╝"
...
def pilih_super():
	...
	print "\n\033[0;39m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
	print "\033[0;39m BUANG HPNYA JIKA TIDAK ADA HASIL"
	print "\033[0;39m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
